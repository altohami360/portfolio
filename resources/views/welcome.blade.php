...
@section('content')
    ...
    <div class="bg-gray-900">
        <h2 class="text-white text-3xl my-6">Hi 👋<br>Don't be shocked. when I working the screen look like this. <br>because i'm back end engineer 😎.
        </h2>

        {{--    <div class="w-full h-7 border border-3 border-gray-500 fixed bg-black p-2 rounded-t">--}}
        {{--    </div>--}}
        <div class="bg-black border border-3 border-gray-500 rounded py-4">
            ...
            <div class="bg-gray-500 my-4 w-full border border-3 border-gray-500"></div>
            ...
            <div class="px-4">
                ...
                <x-portfolio.experience title="Laravel Developer"
                                        company="Electronic Charitable Society for Memorizing the Holy Quran" start-date="2021/3/1"
                                        end-date="*">
                    ...
                    RESTfull API’s for client site.
